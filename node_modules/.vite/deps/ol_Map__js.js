...
import {
  ...
  toPromise,
  unlistenByKey
} from "./chunk-LJSKYLJO.js";
import {
  ascending,
  assert,
  equals as equals2
} from "./chunk-ASUUFVZK.js";
import {
  clamp,
  clear,
  fromUserCoordinate,
...
var LayerGroup = class extends Base_default {
  ...
  getLayers() {
    return this.get(Property3.LAYERS);
  }
  setLayers(layers) {
...
var Map = class extends Object_default {
  ...
  handleMapBrowserEvent(mapBrowserEvent) {
    ...
    if (eventType === EventType_default3.POINTERDOWN || eventType === EventType_default.WHEEL || eventType === EventType_default.KEYDOWN) {
      ...
      if (this.overlayContainerStopEvent_.contains(target) || !currentDoc.contains(target)) {
        return;
      }
    }
